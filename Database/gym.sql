...
SELECT SHOP_NAME AS "Shop name", PRODUCT_NAME as "Product name", PRODUCT_PRICE as "Price [zl]", PRODUCT_AMOUNT as "Amount"
FROM SHOP_PRODUCTS
...
----------------------------------------
INSERT INTO PERSONAL_DATA(PERSONAL_DATA_ID, FIRST_NAME, LAST_NAME, ADDRESS_ID, PHONE_NUMBER, EMAIL) VALUES(1, 'Kamil', 'Kowalewski', 1, '158659426', 'kamilKow@gmail.com');
